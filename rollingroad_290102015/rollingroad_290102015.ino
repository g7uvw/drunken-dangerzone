...
start:
    ...
    if (getFREQaverage(2) < 10)            // wait for some road pulses
        roadenable = 0;
    else
        roadenable = 1;
    ...
    while (controllingroad)
    {
        ...
        if (currentspeed < (basespeed - 5))   // 5 mph less than base speed, turn off controls
        {
        ...
        {
            PWM_extra = speederror * SCALEFACTOR;
